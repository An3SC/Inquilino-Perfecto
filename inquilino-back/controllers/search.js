...
const search = async (req, res, next) => {
    ...
    try {
        ...
        let query = `select piso.id, piso.precio_piso, avg(reserva.score_piso) 'avg_score', avg(reserva.score_usuario) 'score_usuario', count (score_piso) as countScores, piso.imagen 'imagen', piso.provincia, piso.ciudad, piso.m2, piso.direccion from piso
