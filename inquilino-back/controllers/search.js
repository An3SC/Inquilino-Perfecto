...
const search = async (req, res, next) => {
    ...
    try {
        ...
        let query = `select piso.id, piso.precio_piso, avg(reserva.score_piso) 'score_piso', avg(reserva.score_usuario) 'score_usuario', piso.imagen 'imagen', piso.provincia, piso.ciudad, piso.m2, piso.direccion from piso
